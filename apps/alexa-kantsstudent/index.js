...
const answers=[
  ...
  "It can be said there is a collective subjectivity These collective intuitions in its developed state present a system of reasoning in the context of which it can be said an individual is using proper reason",
